    ...
    <section id="about" className="bg-primary py-12 md:py-16">
      <div className="max-w-screen-2xl mx-auto px-6 md:px-12">
        ...
        <div className="max-w-3xl mb-10">
          ...
          <p className="text-white/80 text-[16px] md:text-lg leading-relaxed max-w-2xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
          ...
          <div className="space-y-8">
            <h3 className="text-[13px] font-black uppercase tracking-widest text-accent mb-6">Our Operating Principles</h3>
            {pillars.map(({ icon, title, desc }) => (
              <div key={title} className="flex items-start gap-5">
                ...
                <div>
                  <h4 className="text-white font-black text-[16px] uppercase tracking-widest mb-2">{title}</h4>
          ...
          <div>
            <h3 className="text-[13px] font-black uppercase tracking-widest text-accent mb-6">Certifications &amp; Regulatory Standing</h3>
            <div className="space-y-4">
              {certs.map(({ label, detail }) => (
                <div key={label} className="border border-accent/30 p-5 flex items-start gap-4 hover:border-accent/60 transition-colors">
                  <span
                  ...
                  <div>
                    <p className="text-white font-black text-[15px] uppercase tracking-widest">{label}</p>
                    <p className="text-white/75 text-[14px] mt-1 leading-relaxed">{detail}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="mt-6 bg-white/8 border border-accent/40 p-6">
              <p className="text-[15px] font-black uppercase tracking-widest text-white mb-2">U.S. Federal Market Access</p>
        ...
        {/* Bottom stat bar */}
        <div className="border-t border-accent/30 pt-10 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={label} className="text-center">
              ...
              <p className="text-white/70 text-[15px] uppercase tracking-widest font-semibold mt-2">{label}</p>
            </div>
          ))}
        </div>
